...
import com.example.bitirmeprojesi.databinding.SearchfragmentToprecyclerBinding
import com.example.bitirmeprojesi.model.TravelApi
import com.example.bitirmeprojesi.model.TravelModel


class SearchTopAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class MyCustomHolder(private val topBinding: ViewDataBinding) :
        ...
        fun setBind(travelApi: TravelApi) {
            topBinding as SearchfragmentToprecyclerBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        topBinding = DataBindingUtil.inflate(
            ...
            R.layout.searchfragment_toprecycler,
            parent,
            false
        )
